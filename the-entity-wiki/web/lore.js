...
var TIMELINE_DATA = {
  releases: [
    ...
    {
      "id": "all-kill-comeback",
      "name": "All-Kill: Comeback",
      "type": "paragraph",
      "date": "2026-03-12",
      "displayDate": "March 12, 2026",
      "description": "A comeback release revisiting All-Kill with Kwon Tae-Young, the Sleepless District realm, Trickster's Delusion, and a major Trickster overhaul.",
      "killers": [
        {
          "id": "trickster",
          "name": "The Trickster",
          "realName": "Ji-Woon Hak",
          "fogEntry": "The killer who turned screams into art earned a deadlier encore in the Entity's realm. In the Sleepless District, Ji-Woon's obsession with spectacle became a neon nightmare where every blade throw feeds his rising Style.",
          "licensed": false
        }
      ],
      "survivors": [
        {
          "id": "kwon-tae-young",
          "name": "Kwon Tae-Young",
          "fogEntry": "A brilliant choreographer and creative mind from Seoul, Kwon built a career around predicting movement and guiding others through chaos. When the Fog swallowed the Sleepless District, he relied on that same awareness to stay one move ahead of the nightmare hunting him.",
          "licensed": false
        }
      ],
      "maps": [
